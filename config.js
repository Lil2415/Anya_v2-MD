...
module.exports = {
  botname: process.env.BotName || "Personified Bot", 
  author: process.env.Author || "@PersonifiedBotz",
  packname: process.env.PackName || "Personified v2 MD",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Personified Bot",
  prefa: process.env.Prefix || ['.'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Pika~Kun",
  ownernumber: process.env.Owner_Number || "254756418391",
